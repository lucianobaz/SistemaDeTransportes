...
public class PaqueteEstandar extends Paquete {
    ...
    private double costoBase; //costo base fijo

    //Constructor básico: permite crear el paquete sin camionero para asignarlo más adelante.
    ...
    //Constructor completo: permite crear el paquete ya asignado a un camionero.
